...
<body id="minwidth-body" class="<?php echo $this->params->get('headerColor','green');?>">
	<div id="header-box">
	<div id="vt_logo">
 <a href="http://www.laguiapuntana.com.ar/administrator/index.php" target="" title="GuiaPuntana "><img src="templates/<?php echo  $this->template ?>/images/logo_<?php echo $this->params->get('headerColor','green');?>.png" /></a>	 
 </div>
	...
	<div id="footer">
		<p class="copyright">
         ...
         <p class="copyright">       
             <a href="http://www.laguiapuntana.com.ar/administrator/index.php" target="_blank" title="GuiaPuntana "><img src="templates/<?php echo  $this->template ?>/images/system/vtem-logo.png" /></a>
		</p>
	</div>
</body>
</html>