...
<?php }   ?>
        <p class="width18 floatleft" id="com-form-login-username">
        ...
        <p class="width18 floatleft" id="com-form-login-password">
        ...
        <p class="width25 floatleft" id="com-form-login-remember">
