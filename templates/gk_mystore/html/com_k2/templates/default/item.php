...
<div id="k2Container" class="itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
  ...
  $this->item->params->get('itemAttachments')
    ...
    <div class="itemAuthorLatest">
        <h3><span><?php echo JText::_('K2_LATEST_FROM'); ?>
            <?php echo $this->item->author->name; ?></span></h3>
        <ul>
    ...
    <div class="itemComments">
        ...
        <div class="ribbonEl"> 
            <h3><?php echo $this->item->numOfComments; ?>
            <?php echo ($this->item->numOfComments>1) ? JText::_('K2_COMMENTS') : JText::_('K2_COMMENT'); ?></h3>
        </div>
